...
|---|---|---|
| Server `loops-routing-1` (id 166821563) | CX33 · 4 vCPU / 8 GB / 80 GB · Ubuntu 24.04 · Falkenstein (fsn1) · IPv4 **2.28.33.245** | €10.44 |
...
`http://2.28.33.245:17777/brouter?lonlats=-6.11,53.57|-6.05,53.60&profile=fastbike&alternativeidx=0&format=geojson`
