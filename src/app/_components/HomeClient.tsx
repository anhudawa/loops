...
export default function HomeClient() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "var(--bg)" }}>
      ...
      {/* Scroll anchor — must be outside header for scrollIntoView to work */}
      <div id="scroll-anchor" />

      {/* Header */}
      <header className="px-4 md:px-6 py-3 border-b" style={{ background: "var(--bg-raised)", borderColor: "var(--border)" }}>
