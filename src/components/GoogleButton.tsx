...
/** Google sign-in button. "Continue" fits both a returning rider and a new one (the account is created on first sign-in). */
  ...
  return (
    <button
      ...
      className={`flex items-center justify-center gap-2.5 rounded-xl font-bold uppercase tracking-wider transition-all hover:opacity-90 hover:scale-[1.02] ${
        size === "small" ? "px-5 py-3.5 min-h-[44px] text-xs" : "w-full py-3.5 min-h-[44px] text-sm"
      }`}
