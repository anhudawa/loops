...
export const winterCamps: BlogPost = {
  slug: "best-winter-cycling-training-camps-europe",
  title: "Best Winter Cycling Training Camps in Europe",
  description:
    "Where to escape the cold and build winter base miles: Calpe, Mallorca, Girona, Tenerife and the Algarve compared on weather, terrain, logistics and cost.",
  excerpt:
  ...
  readingTime: 10,
  keywords: [
    "winter cycling training camp",
    "warm weather cycling Europe",
    "Calpe cycling",
    "Tenerife cycling",
  ...
  body: [
    ...
    { type: "h2", text: "Calpe, Spain (Costa Blanca)" },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Mallorca's main camp season is February–April, but the island is rideable through winter with mild, if cooler and shorter, days. The advantage is unmatched terrain variety — flat plains for base and the Tramuntana climbs for intensity — plus the cheapest flights of any destination here thanks to Palma's huge airport. The trade-off is that December and January can bring the occasional wet, cool spell, so it's a better choice from late February onward.",
    },
    { type: "h2", text: "Tenerife, Canary Islands" },
    {
      type: "p",
      text: "If you want guaranteed sun and serious altitude, Tenerife is the answer. The island offers the most reliable winter warmth in Europe and a single colossal climb — the road up Mount Teide rises from sea level to over 2,000 m. That makes it the premier destination for high-altitude camps and for riders who want enormous climbing volume. The downside is that it's effectively one giant mountain: the riding is up or down, with little flat, and flights are longer than to mainland Spain.",
    },
  ...
  faqs: [
    {
      question: "Where is the best winter cycling training camp in Europe?",
      answer:
    ...
    {
      question: "When does the European cycling camp season start?",
      answer:
    ...
    {
      question: "How long should a winter training camp be?",
      answer:
    ...
    {
      question: "Is Tenerife or Mallorca better for winter cycling?",
      answer:
    ...
    {
      question: "What should I do to prepare for a winter cycling camp?",
      answer:
