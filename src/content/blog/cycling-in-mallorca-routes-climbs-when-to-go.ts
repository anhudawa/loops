...
export const mallorca: BlogPost = {
  slug: "cycling-in-mallorca-routes-climbs-when-to-go",
  title: "Cycling in Mallorca: Routes, Climbs and When to Go",
  description:
    "The complete guide to cycling in Mallorca: Sa Calobra and the Tramuntana climbs, the best loops, when to visit, where to stay and how to plan your training camp.",
  excerpt:
  ...
  body: [
    ...
    { type: "h2", text: "Logistics and where to stay" },
    {
      type: "p",
      text: "Palma de Mallorca airport is one of Europe's busiest in summer and is well connected to almost every major city, keeping flights cheap. Most cyclists stay in Port de Pollença, Alcúdia or Cala Sant Vicenç in the northeast for instant mountain access. Bike-friendly hotels are the norm — secure storage, early breakfasts and on-site rental are standard. If you prefer flat-first riding, Playa de Muro and the central towns work well too.",
    },
    {
      type: "p",
      text: "Mallorca's long, steady climbs make it a superb venue for structured efforts. If you're building a block around it, our guide to [VO2 max intervals outdoors](/blog/vo2-max-intervals-complete-outdoor-guide) and [where to do threshold intervals safely](/blog/where-to-do-threshold-intervals-safely-outdoors) will help you pick the right climb for the right session.",
    },
    {
      type: "cta",
  ...
  faqs: [
    {
      question: "Why is Mallorca so popular for cycling?",
      answer:
    ...
    {
      question: "What is the most famous climb in Mallorca?",
      answer:
    ...
    {
      question: "Where should I stay for cycling in Mallorca?",
      answer:
