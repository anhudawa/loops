...
export const wicklow: BlogPost = {
  slug: "cycling-in-wicklow-dublins-mountain-playground",
  title: "Cycling in Wicklow: Dublin's Mountain Playground",
  description:
    "The complete road cycling guide to the Wicklow Mountains: the Sally Gap, Wicklow Gap, classic loops from Dublin, weather and when to go.",
  excerpt:
  ...
  body: [
    ...
    {
      type: "p",
      text: "Let's be honest: this is Ireland, and the mountains make their own weather. The Sally Gap can be in cloud and wind when Dublin is sunny, and conditions change fast. May to September offers the most settled riding and the longest days, with summer evenings perfect for after-work spins into the hills. Spring and autumn are beautiful but demand layers and a rain jacket. Winter riding is very doable on milder days, but check the forecast for ice on the high passes and carry warm kit — exposure up top is the real risk, not cold in the valleys.",
    },
    { type: "h2", text: "Logistics" },
    {
      type: "p",
      text: "Wicklow's huge advantage is access: it's a self-powered ride from Dublin city, and Dublin Airport connects to everywhere. Many riders start from the southern suburbs (Rathfarnham, Dún Laoghaire) to skip the urban roads. Café stops are plentiful in the villages — Roundwood, Laragh, Enniskerry and Glendalough are the classic refuelling points. If you're training to a plan, the long, steady Gaps are ideal for [threshold intervals](/blog/where-to-do-threshold-intervals-safely-outdoors), while the quiet valley roads suit easy [Zone 2 endurance](/blog/how-to-structure-a-zone-2-endurance-ride) days.",
    },
    {
      type: "cta",
      text: "Starting in Dublin? Search current human-ridden road loops by distance, terrain and supported session. LOOPS will show no match rather than invent a route.",
      href: "/generate",
      label: "Search Dublin & Wicklow",
    },
  ],
  faqs: [
    {
    ...
    {
      question: "What are the best climbs in the Wicklow Mountains?",
      answer:
    ...
    {
      question: "How do you cycle from Dublin to the Wicklow Mountains?",
      answer:
